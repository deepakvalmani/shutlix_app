...
app.get('/api/health', (req, res) => {
  res.json({ success: true, message: 'ShutlliX API is running', environment: process.env.NODE_ENV, timestamp: new Date().toISOString() });
});
...
server.listen(PORT, () => {
  console.log(`\n🚌 ShutlliX server running on port ${PORT}`);
